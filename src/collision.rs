...
pub fn circle_rect_collision(circle_pos: Vec2, radius: f32, rect_x: f32, rect_y: f32, rect_w: f32, rect_h: f32) -> bool {
...
pub fn point_in_rect(point: Vec2, rect_x: f32, rect_y: f32, rect_w: f32, rect_h: f32) -> bool {
    point.x >= rect_x && point.x <= rect_x + rect_w && point.y >= rect_y && point.y <= rect_y + rect_h
}
